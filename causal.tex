...
\bigskip 
    \item David Hume (Skeptism): Causation as a relationship between two impressions in the mind. 
...
\begin{frame}{Treatment Effect}
    \begin{itemize}
        ...
        \item $\Delta _{i}$ is unobservable. Researchers only observe either $y_{1i}$ or $y_{0i}$, but not both
...
\bigskip
        ...
        \item $E[y_i | X_i]$ always exists, but the linear regression may not get what you want.
...
\begin{frame}{Interpretation of Linear Regression: II}
        ...
        \bigskip
            ...
            \item Importance of the causal model: Only the causal relationship has policy implications (under partial equilibrium)
        \end{itemize}
...
\begin{itemize}
    ...
    \bigskip
    \item Popular in academia as well as tech industry
\end{itemize}
