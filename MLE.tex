...
\begin{itemize}
    ...
    \item (Statistician) $L(\theta;\mathbf{Y})$ is a function of $\theta$ given the observed data $\mathbf{Y}$
...
KLIC\left(f,g\left(z;\theta\right)\right) & =\int f\left(z\right)\log f\left(z\right)dz-\int f\left(z\right)\log g\left(z;\theta\right)dz\\
 ...
 & =E\left[\log f\left(z\right)\right]-\ell\left(\theta\right) > 0
\end{align*}
