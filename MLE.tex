...
\begin{frame}{In the Era of AI}
    \begin{itemize}
        ...
        \pause \bigskip
        \item Welcome to the beautiful new era
    \end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Less commonly used than Wald test
    \end{itemize}
\end{itemize}
...
\begin{frame}{Comparison of Three Tests}
...
& Wald & LM & LR \\
\midrule
Unconstrained $\hat{\theta}$ & \checkmark & & \checkmark \\
Constrained $\tilde{\theta}$ & & \checkmark & \checkmark \\
...
\begin{itemize}
    \item Asymptotically equivalent: $W \approx LM \approx LR$ under $H_0$
    
    \item In finite samples: typically $W \geq LR \geq LM$
    
    \item Choice depends on computational convenience and context
\end{itemize}
